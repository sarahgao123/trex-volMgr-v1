    ...
    <form onSubmit={onFormSubmit} className="space-y-4">
      ...
      <div>
        ...
        <input
          ...
          min={toLocalDateTimeString(position.start_time)}
          max={toLocalDateTimeString(position.end_time)}
          onChange={(e) => setFormData({ ...formData, start_time: e.target.value })}
          className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
        />
        <HelpText>Must be within position time range</HelpText>
      </div>
      ...
      <div>
        ...
        <input
          ...
          min={formData.start_time || toLocalDateTimeString(position.start_time)}
          max={toLocalDateTimeString(position.end_time)}
